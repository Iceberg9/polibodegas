...
<div class="ContenedorGeneral">
	...
	<div class="inicio-bloque-destacada" style="background: url(http://dev04.iceberg9.com/wp-content/uploads/2016/03/bg-homepage.png) top center no-repeat; background-size: cover">
		...
		<div class="des-destacada">
			...
			<h1>¿Necesitas una mini-bodega?</h1>

			<a href="http://dev04.iceberg9.com/ubicacion-y-contacto/">Consulta disponibilidad aquí</a>

			<p>Más información en nuestras preguntas frecuentes</p>
	...
	<!-- Sección Almacenamiento para todos -->
	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-xs-12">
				...
				<div id="seccion-1" class="secciones">
					...
					<a href="http://dev04.iceberg9.com/tamanos-y-precios/">Consulta nuestros tamaños y precios</a>

				</div>

				<div id="seccion-2" class="secciones">
					...
					<a href="http://dev04.iceberg9.com/ubicacion-y-contacto/">Conoce nuestra ubicación</a>

				</div>

				<div id="seccion-3" class="secciones">
					...
					<a href="http://dev04.iceberg9.com/instalaciones-y-servicios/">Conoce nuestras instalaciones y servicios</a>
